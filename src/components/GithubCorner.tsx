...
import styles from '@styles/components/GithubCorner.module.css';

export function GithubCorner() {
  return (
      <Link to='https://github.com/SadS4ndWiCh/minesweeper-nextjs' className={styles.githubCornerContainer}>
